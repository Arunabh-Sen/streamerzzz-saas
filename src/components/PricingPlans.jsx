        ...
        <section id="pricing">
            <div className="max-w-7xl mx-auto px-4 mt-20">
                ...
                <motion.div
                    ...
                    className="grid hover:cursor-pointer grid-cols-1 md:grid-cols-3 gap-8"
                >
                    {PLANS_CONTENT.plans.map((plan, index) => (
                        <motion.div
                            ...
                            whileHover={{
                                boxShadow: plan.popular
                                    ? "0px 0px 40px rgba(59, 130, 246, 0.6)" // Stronger blue glow for popular
                                    : "0px 0px 25px rgba(255, 255, 255, 0.2)", // Subtle white glow for others
                            }}
                            transition={{ duration: 0.4, ease: "easeOut" }}
                            className={`p-8 rounded-xl shadow-lg bg-neutral-950 transition-all duration-300 ${
                                plan.popular
                        ...
                        >
                            ...
                            <button className="w-full hover:cursor-pointer py-3 px-4 bg-blue-600 hover:bg-blue-500 rounded-lg">
