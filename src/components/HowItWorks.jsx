                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
                    {HOW_IT_WORKS_CONTENT.steps.map((step, index) => (
                        <motion.div
                            ...
                            viewport={{ once: true }} // Run animation only once and keep it there
                            variants={stepVariants}
                            className='bg-[#0d061d] p-6 rounded-xl shadow-lg flex flex-col justify-between'
                        >
                            <div>
                            ...
                            {step.users && (
                                <div className='flex justify-between items-center mt-4'>
                                    ...
                                    <button 
                                        className='bg-blue-600 hover:bg-blue-500 active:bg-blue-700 text-white py-2 px-4 rounded-lg transition-all'
